...
## Experimental Design
sample_name <- c("ND4_H3K27me3_1","ND4_H3K27me3_2","D4_H3K27me3_1","D4_H3K27me3_2")
...
## Make sample sheet
sample.sheet <- data.frame(c("ND4_H3K27me3_1","ND4_H3K27me3_2","D4_H3K27me3_1","D4_H3K27me3_2"), 
                           c("non_diapause", "non_diapause","diapause", "diapause"),
                           c(1,2,1,2),
                           c(paste(bf.dir.1,"H3K27me3_ND1_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_ND2_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_D1_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_D2_sorted_F1540_q15.bam",sep="/")),
                           c("ND_input","ND_input", "D_input","D_input"),
                           c(paste(bf.dir.1,"input_ND_K4K27_sorted_F1540_q15.bam",sep="/"),
                             ...
                             paste(bf.dir.1,"input_D_K4K27_sorted_F1540_q15.bam",sep="/")),
                           c(paste(peak.dir.1,"ND1_H3K27me3_macs2_peaks.broadPeak",sep="/"),
                             paste(peak.dir.1,"ND2_H3K27me3_macs2_peaks.broadPeak",sep="/"),
                             paste(peak.dir.1,"D1_H3K27me3_macs2_peaks.broadPeak",sep="/"),
...
pdf("H3K27me3_allplots1.pdf", 10, 8)
...
#write.table(MyChIP.DBA.counts.ana.all.notsig.ann.df,"DiffBind_H3K27me3_greater_fdr01_notsig.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(MyChIP.DBA.counts.ana.all.ann.df,"DiffBind_H3K27me3_all_peaks_nondiapause.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(MyChIP.DBA.counts.ana.DB.1dpa.up.ann.df,"DiffBind_H3K27me3_fdr01_up_nondiapause.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
pdf("H3K27me3_heatmap_nondiapause.pdf", 10, 8)
