...
setwd("/home/wew/Chip_Seq/diapause6/Analysis_H3K27me3")


## Experimental Design
sample_name <- c("D4_H3K27me3_1","D4_H3K27me3_2","ND4_H3K27me3_1","ND4_H3K27me3_2")
input <- c("D4_input","D4_input","ND4_input","ND4_input")
timepoint <- c("diapause","diapause","nondiapause","nondiapause")
antibody <- c("H3K27me3","H3K27me3","H3K27me3","H3K27me3")
replicates <- rep(2, 4)
...
peak.dir.1 <- "/home/wew/Chip_Seq/diapause6/H3K27me3/H3K27me3"
## Make sample sheet
sample.sheet <- data.frame(c("D4_H3K27me3_1","D4_H3K27me3_2","ND4_H3K27me3_1","ND4_H3K27me3_2"), 
                           c("diapause", "diapause","non_diapause", "non_diapause"),
                           c(1,2,1,2),
                           c(paste(bf.dir.1,"H3K27me3_D1_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_D2_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_ND1_sorted_F1540_q15.bam",sep="/"),
                             paste(bf.dir.1,"H3K27me3_ND2_sorted_F1540_q15.bam",sep="/")),
                           ...
                           c(paste(bf.dir.1,"input_D_K4K27_sorted_F1540_q15.bam",sep="/"),
                             ...
                             paste(bf.dir.1,"input_ND_K4K27_sorted_F1540_q15.bam",sep="/")),
                           c(paste(peak.dir.1,"D1_H3K27me3_macs2_peaks.broadPeak",sep="/"),
                             paste(peak.dir.1,"D2_H3K27me3_macs2_peaks.broadPeak",sep="/"),
                             paste(peak.dir.1,"ND1_H3K27me3_macs2_peaks.broadPeak",sep="/"),
                             paste(peak.dir.1,"ND2_H3K27me3_macs2_peaks.broadPeak",sep="/")),
                           c(rep("narrow",4)))
...
pdf("H3K27me3_PCAMABOX.pdf", 10, 8)
...
write.table(MyChiP.DBA.counts.ana.all.ann.df,"DiffBind_H3K27me3_all_peaks_annotated.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(MyChiP.DBA.counts.ana.DB.1dpa.up.ann.df,"DiffBind_H3K27me3_diapause_up.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(MyChiP.DBA.counts.ana.DB.1dpa.down.ann.df,"DiffBind_H3K27me3_diapause_down.txt", row.names = FALSE, quote = FALSE, sep = "\t")
...
bam.files <- bam.files.1[grepl("H3K27me3", bam.files.1)]

sml.3 <- ScoreMatrixList(bam.files, MyChiP.peaks, bin.num = 80, type = "bam")
names(sml.3) <- c("D4_H3K27me3_1","D4_H3K27me3_2","ND4_H3K27me3_1","ND4_H3K27me3_1")

pdf("H3K27me3_heatmaptest_diapause_enrichedpeaks.pdf", 10, 8)
...
plotMeta(sml.3, xcoords = c(-2000, 2000), centralTend = "mean", 
         profile.names = c("D4_H3K27me3_1","D4_H3K27me3_2","ND4_H3K27me3_1","ND4_H3K27me3_1"),
         winsorize=c(0,97))
...
#MyChiP.peaks <- MyChiP.DBA.counts.ana.all
...
pdf("H3K27me3_heatmaptest_diapause_global_peaks.pdf", 10, 8)
multiHeatMatrix(sml.3, xcoords = c(-2000, 2000), order = TRUE, winsorize=c(0,97), common.scale=TRUE, 
                col = c("white", "pink"))
multiHeatMatrix(sml.3, xcoords = c(-2000, 2000), order = TRUE, winsorize=c(0,97), common.scale=TRUE)
